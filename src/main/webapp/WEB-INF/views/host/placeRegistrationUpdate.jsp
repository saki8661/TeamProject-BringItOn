<%@ page import="com.example.teamprojectbringiton.space.Space" %>
...
<div class="reservation_background">
    ...
    <div class="reservation_container">
        <form action="/space/space-update" method="post" enctype="multipart/form-data">
                        ...
                        <div class="place_resistration_letter">
                            ...
                            <div class="place_resistration_name">
                                <input class="place_resistration_txt" name="spaceName" style="resize: none"
                                       placeholder="시설명을 입력해주세요." value="${space.spaceName}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="re_time_choice_two">
                ...
                <div class="">
                    ...
                    <input name="description" class="place_resistration_txt" style="resize: none"
                           placeholder="공간을 소개하는 글을 작성해주세요!" value="${space.description}">
                </div>
            </div>
            ...
            <div class="re_person_choice">
                ...
                <input type="hidden" name="capacity" id="personnel" value="${space.capacity}">
                <div class="re_person_count" id="personnelId">
                    <input type='button'
                           onclick='count("minus")'
                           value='-'/>
                    <div class="re_count_number" id='result'>${space.capacity}</div>
                    <input type='button'
            ...
            <div class="place_resistration_thumbnail">
                ...
                <label class="place_resistration_thumbnail_label" style="margin-right: 30px" for="customFile">이미지
                    등록</label>
                <div class="place_resistration_thumbnail_container_two">
                    <input type="file" style="display: none" class="place_resistration_thumbnail_input" id="customFile"
                           name="file" onchange="changePic(event)">
                    <img id="preview" class="circle_avatar img_size" src="/img/${spacePic.spacePic}">
                </div>
            ...
            <div class="place_resistration_tel_container">
                ...
                <div class="place_resistration_tel_number_container">
                    <input class="place_resistration_tel_number" style="resize: none" name="sector"
                           placeholder="사하 풋살장 -> 사풋" value="${space.sector}">
                </div>
            </div>
            ...
            <div class="place_resistration_address_container">
                ...
                <div class="place_resistration_address_search">
                    <input type="text" class="form-control" id="placeAddress" placeholder="주소" name="spaceLocation"
                           onclick="findAddr()" required value="${space.spaceLocation}">
                </div>
            </div>
                ...
                <div class="place_resistration_rent_time_menu">
                    <div style="margin-right: 5px">
                        ...
                        <input name="bizStartTime" type="text" id="minTime" placeholder="최소 시간 입력"
                               value="${space.bizStartTime}">
                    </div>
                    <div style="margin-right: 5px">
                        <label for="maxTime">CLOSE:</label>
                        <input name="bizEndTime" type="text" id="maxTime" placeholder="최대 시간 입력"
                               value="${space.bizEndTime}">
                    </div>

                    <select id="place_resistration_rent_time_dropdown3" name="sportId">
                        <option value="1" ${space.sportId == 1 ? "selected" : ""}>축구</option>
                        <option value="2" ${space.sportId == 2 ? "selected" : ""}>농구</option>
                        <option value="3" ${space.sportId == 3 ? "selected" : ""}>풋살</option>
            ...
            <div class="re_matching_check">
                <div>
                    ...
                    ${space.isInside ? "checked" : ""} required>
