    ...
    <div id="MainBanner" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="/images/BasketballMainBanner.png" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="/images/SoccerMainBanner.png" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="/images/FutsalMainBanner.png" class="d-block" style="width:100%">
            </div>
        </div>
