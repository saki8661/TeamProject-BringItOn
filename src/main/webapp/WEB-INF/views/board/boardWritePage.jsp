...
<div class="frame">
    <div class="container mt-3" style="padding-top: 50px;">
        <form action="/board-write" method="post">
            <div class="mb-5 mt-3">
                <input type="text" class="form-control form-control-lg mb-5" value="" placeholder="제목을 입력해 주세요" name="boardTitle">
            ...
            <div class="mt-3" style="padding-bottom: 20px;">
                <button type="submit" class="btn btn-outline-success float-end">등록하기</button>
            </div>
        </form>
    </div>
</div>
